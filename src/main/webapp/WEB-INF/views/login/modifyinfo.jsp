      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="page-heading">
            <h1>Sign up</h1>
            <span class="subheading">회원정보 수정 화면입니다.</span>
          </div>
        </div>
      </div>
    </div>
...
<!-- wrapper -->
		...
		<form role="form" action="/login/modifyinfo" name="userinfo" id="userinfo" method="post">
            <!-- content-->
            <div id="content">
                ...
                <div>
                    ...
                    <span class="box int_id">
                        <input type="text" id="userid" name="userid" class="int" maxlength="20" value="${userinfo.userid }" readonly>
                ...
                <div>
                    ...
                    <span class="box int_pass">
                        <input type="text" id="userpw" name="userpw" class="int" maxlength="20" required>
                ...
                <div>
                    ...
                    <span class="box int_name">
                        <input type="text" id="username" name="username" class="int" maxlength="20" value="${userinfo.username }">
                    </span>
                    <span class="error_next_box"></span>
                </div>
                ...
                <div>
                    ...
                    <div id="bir_wrap">
						...
						<input type="text" id="birthday" name="birthday" value="${userinfo.birthday }">
                    </div>
                    <span class="error_next_box"></span>    
                </div>
                ...
                <div>
                    ...
                    <span class="box int_email">
                        <input type="text" id="email" name="email" class="int" maxlength="100" value="${userinfo.email }">
                    </span>
                ...
                <div>
                    ...
                    <span class="box int_mobile">
                        <input type="tel" id="phoneno" name="phoneno" class="int" maxlength="16" value="${userinfo.phoneno }">
                    </span>
                    <span class="error_next_box"></span>    
                </div>
                ...
                <div class="btn_area">
            		...
            		<button type="submit" class="formbutton"  data-oper="modify">정보 변경</button>
					<button type="submit" class="formbutton"  data-oper="remove">회원 탈퇴</button>
					<button type="submit" class="formbutton"  data-oper="list">마이페이지</button>
                </div>
	...
	$(".formbutton").on("click", function(e) {
		  ...
		  if (operation === 'remove') {
			  if (confirm("정말 삭제하시겠습니까??") == true){    //확인
		  		 formObj.attr("action", "/login/removeinfo");
				 formObj.submit();
		 	 }else{   //취소
		 	     return false;
		 	 }
			...
			formObj.attr("action", "/login/mypage");
			formObj.submit();
