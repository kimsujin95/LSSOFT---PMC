...
<!--          <div class="panel-heading">
         ...
         <i class="fa fa-comments fa-fw"></i> Reply
         <div class="pull-right">
            <button id='addReplyBtn' class='btn btn-outline-warning'>New Reply</button>
         </div>
         </div>
         <br>
         <!-- /.panel-heading -->
      ...
      <div class="model-dialog">
         <div class="modal-content">
            ...
            <div class="modal-footer">
               ...
               <button id='modalCloseBtn' type="button" class='btn btn-defa
               ult' data-dismiss='modal'>Close</button>
            </div>
         </div>
         <!--  /.modal-content -->
      </div>
